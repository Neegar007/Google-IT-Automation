...
FILE_URL = "https://storage.googleapis.com/gwg-content/gic215/emplo/employees-with-date.csv"
...
def get_same_or_newer(start_date):
  # Returns the employees that started on the given date, or the c>
  data = get_file_lines(FILE_URL)
  reader = csv.reader(data[1:])

  # We want all employees that started at the same date or the clos>
  # date. To calculate that, we go through all the data and find the
  # employees that started on the smallest date that's equal or big>
